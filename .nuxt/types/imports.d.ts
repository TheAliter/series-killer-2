...
declare global {
  ...
  const findOrCreateAuthor: typeof import('../../utils/bookSearch').findOrCreateAuthor
  ...
  const processOpenLibraryBook: typeof import('../../utils/bookSearch').processOpenLibraryBook
...
declare global {
  ...
  // @ts-ignore
  export type { BookSearchResult } from '../../utils/bookSearch'
  import('../../utils/bookSearch')
}
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly findOrCreateAuthor: UnwrapRef<typeof import('../../utils/bookSearch')['findOrCreateAuthor']>
    ...
    readonly processOpenLibraryBook: UnwrapRef<typeof import('../../utils/bookSearch')['processOpenLibraryBook']>

/**
 * Better Auth component schema (from @convex-dev/better-auth).
 * Regenerate with: npx @better-auth/cli generate --config ./convex/betterAuth/auth.ts --output ./convex/betterAuth/schema.ts -y
 */
